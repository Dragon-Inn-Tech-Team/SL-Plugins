...
using CustomCommands.Features.CustomEvents;
...
namespace CustomCommands.Core.Event
{
	public abstract class KillfeedEvent : CustomEventRound
	{
		public KillfeedEntry[] KillfeedEntries = new KillfeedEntry[5];
		...
		{
			KillfeedEntries[4] = KillfeedEntries[3];
			KillfeedEntries[3] = KillfeedEntries[2];
